...
TAGS = ['v1.0', 'v2.0.1', 'v2.1.0', 'v2.1.1', 'v2.1.2', 'v2.1.3', 'v2.2.0', 'v2.2.1', 'v2.2.2', 'v2.3.0', 'v2.3.1', 'v2.3.2', 'v2.3.3', 'v2.3.4', 'v2.3.5', 'v2.3.6', 'v2.3.7']   # 最后一个当"最新版"，附件挂在它上面
LATEST = TAGS[-1]
# 附件名用 ASCII：GitHub 会把非 ASCII 名字削成 default.exe / -.png（踩过）
ASSETS = [('宿迁职业技术学院作息时间表.exe', 'sqzy-timetable-v2.3.7-windows.exe'),
          ('宿迁职业技术学院作息时间表.apk', 'sqzy-timetable-v2.3.7-android.apk'),
